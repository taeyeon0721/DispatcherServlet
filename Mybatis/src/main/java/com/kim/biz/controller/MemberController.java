...
public class MemberController { //@RequestMapping이 HandlerMapping의 역할을 해줌!!!
	...
	public String selectOneMember(MemberVO mVO, HttpServletRequest request) {
		//String: 페이지이동만 시킬때
		
		mVO=memberService.selectOneMember(mVO); //로그인을 수행하는 비즈니스 메서드 R
