											...
											<table>
												...
												<tbody>
													<tr>
														...
														<td><img alt="${data.img}" src="images/${data.img}" style="width:70%;,height:70%;"></td>
														<td><input type="file" name="uploadFile" onchange="loadFile(this)"></td>
																							<!-- onchange: 내용이 변경되는 것을 감지 -->
														<td><img alt="미리보기" id="preview" style="width:70%;,height:70%;"></td>
													</tr>
													<tr>
														<td colspan="4" align="right">
														<input type="submit" class="button primary" value="UPDATE">
														<a href="bdelete.do?bid=${data.bid}" class="button primary">DELETE</a>
														</td>
													</tr>
												</tbody>
												<tfoot>
